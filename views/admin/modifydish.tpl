...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form enctype="multipart/form-data" action="/admin/dish" method="POST">
            ...
            <div class="container">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control" id="datetimepicker" name="entrytime" value="{{.Dish.Entrytime}}" aria-describedby="basic-addon1" readonly>
                ...
                <div class="row">
                    <div class="col-md-8">
                      ...
                      {{template "editor" .}}
                      <div id="editor">{{.Dish.Synopsis}}</div>
